<?php 
    ...
    if(isset($_POST['feedbackcheck'])){
        $query="update userfeedback set flag='yes' where flag='no'";
...
-->
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="registration.php"><i class="fa fa-id-card-o" aria-hidden="true"></i>Registration</a>
                    </li>
                    <li>
                        <a href="insertpost.php"><i class="fa fa-fw fa-pencil"></i>Insert new post</a>
                    </li>
                    <li>
